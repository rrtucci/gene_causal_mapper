...
N^{x\rarrow y}++
\\
	\text{Add $(t_a, t'_a, \calx(t_a))$ to a set $\XX(R_1, R_2)$.} 
	\\
	\text{Add $(t_b, t'_b, \caly(t_b))$ to a set $\YY(R_1, R_2)$.}  
\end{array}
\right.
\eeq
...
mapping $(R_1, R_2)$ to
$\XX(R_1, R_2)$,  where the $\XX(R_1, R_2)$ are of the form  \beq\{(t_1,t'_1,  \calx(t_1)), (t_2, t'_2, \calx(t_2)),
(t_3, t'_3, \calx(t_3)), \ldots\}\eeq

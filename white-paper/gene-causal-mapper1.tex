...
\begin{document}
\title{Discoring a Causal DAG for genes via Mappa Mundi algorithm}
\date{ \today}
...
causal DAGs from chronologically ordered data that is imputed either in text or tabular form. 
In this paper, we 
...
in times to obtain the $\dot{q}_i$ columns.
